#
#  Be sure to run `pod spec lint MediaCarousel.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Ryan Brear"
  # spec.authors            = { "Ryan Brear" => "ryanbrear@glucode.com" }
  # spec.social_media_url   = "https://twitter.com/Ryan Brear"
